...
$featurearray = array("Age" => array("40","50","60","70"),"Sex" => array("Male","Female"),"Race" => array("White","African American","Muslim","Asian American"),"Occupation" => array("U.S. Senator","U.S. House Representative","CEO","Mayor"),"Party" => array("Democrat","Republican"),"Military Service" => array("Served","Not Served"),"Education" => array("Small College","Ivy League University"),"TPP" => array("Strong Opposition","Moderate Opposition","Neither Support Nor Opposed","Moderate Support","Strong Support"),"Deploy Ground Troops to Combat ISIS" => array("Strong Opposition","Moderate Opposition","Neither Support nor opposed","Moderate Support","Strong Support"),"Carbon Tax" => array("Strong Opposition","Moderate Opposition","Neither Support nor Opposition","Moderate Support","Strong Support"),"Pathway to Citizenship for Illegal Immigrants brought to US as Children" => array("Strong Opposition","Moderate Opposition","Neither Support nor Opposition","Moderate Support","Strong Support"));

$restrictionarray = array(array(array("Carbon Tax","Moderate Opposition"),array("Party","Democrat")),array(array("Carbon Tax","Strong Opposition"),array("Party","Democrat")));
